...
- [x] Add RED tests for missing Pages site/workflow, tag artifacts and tokenless PyPI gating.
- [x] Implement an allowlisted static public site and immutable Pages workflow.
- [x] Implement credential-independent GitHub artifacts/releases and opt-in OIDC PyPI publication.
